    ...
    <footer className="bg-gradient-to-br from-[#1f1f1f] to-[#0f0f0f] w-full text-gray-300 z-40 py-12 border-t border-gray-700">
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm">khandelwalyash355@gmail.com</p>
          <p className="text-sm">+91 7500752265</p>
          <p className="text-sm text-bold inverted-colors:bg-red-600">MATHURA(281004), India</p>
        </div>
      </div>
